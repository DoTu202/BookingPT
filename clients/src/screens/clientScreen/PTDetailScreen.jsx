...
//   // Handle chat button press - start a chat with PT
...
//       // Navigate to chat screen with this PT
...
//       // Default fallback - just go to chat list
//       navigation.navigate('ChatListScreen');
//     }
//   };
...
//         <View style={styles.loadingContainer}>
//           <TextComponent
//             text="Trainer information not available"
//             color={appColors.gray}
//           />
//           <SpaceComponent height={16} />
//           <ButtonComponent
...
//               {availability
//                 .filter(slot => !slot.isBooked && slot.status === 'available')
//                 .map((slot, index) => {
